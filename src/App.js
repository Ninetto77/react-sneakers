    ...
    <div className="wrapper clear">
        ...
        <div className="content p-40"> 
            ...
            <div className="d-flex">
                <div className="card">
                    <img img width={133} height={112}src="/img/sneakers/1.jpg" alt="Sneakers" />
                ...
                <div className="card">
                    <img img width={133} height={112}src="/img/sneakers/2.jpg" alt="Sneakers" />
                    <h5>Mens sneakers Nike Blazer Mid Suede</h5>
                    <div className="d-flex justify-between align-center">
                        <div className="d-flex flex-column ">
                            <span>Cost:</span>
                ...
                <div className="card">
                    <img img width={133} height={112}src="/img/sneakers/3.jpg" alt="Sneakers" />
                    <h5>Mens sneakers Nike Blazer Mid Suede</h5>
                    <div className="d-flex justify-between align-center">
                        <div className="d-flex flex-column ">
                            <span>Cost:</span>
                ...
                <div className="card">
                    <img img width={133} height={112}src="/img/sneakers/4.jpg" alt="Sneakers" />
                    <h5>Mens sneakers Nike Blazer Mid Suede</h5>
                    <div className="d-flex justify-between align-center">
                        <div className="d-flex flex-column ">
                            <span>Cost:</span>
